                      ...
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="flex items-center gap-1 flex-shrink-0">
                          <Button variant="ghost" size="sm" className="h-7 w-7 p-0"
                            onClick={() => setEditItem({ id: item!.id, category: item!.category as TradingSystemCategory, title: item!.title, content: item!.content, active: Boolean(item!.active) })}>
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  <Button variant="ghost" size="sm" className="h-7 w-7 p-0"
                    onClick={() => setEditItem({
                      ...
                      tags: item.tags ?? "",
                      source: item.source ?? "",
                      conversationDate: item.conversationDate ? new Date(item.conversationDate as any) : null,
                    })}>
                    <Pencil className="w-3.5 h-3.5" />
                  </Button>
                  <Button variant="ghost" size="sm" className="h-7 w-7 p-0 text-destructive hover:text-destructive"
